    ...
    <>
        ...
        <div class="flex-none hidden md:flex">
          <ul class="menu menu-horizontal px-1">
            ...
            <li>
              <a href="https://github.com/lissy93/personal-security-checklist"
                class="tooltip flex tooltip-bottom" data-tip="Исходный код и данные">
                <Icon icon="github" width={16} height={16}  />GitHub
              </a>
            </li>
          </ul>
          <div class="tooltip tooltip-bottom" data-tip="Тема">
          ...
          <li class="list-none px-2">
            <p
              ...
              class="cursor-pointer tooltip flex tooltip-bottom" data-tip="Настройки">
      ...
      <div class="drawer-side z-10">
        ...
        <ul class="rounded-box menu p-4 w-80 min-h-full bg-base-200">
          ...
          <li><a href="/"><Icon class="mr-2" icon="homepage" width={16} height={16}  />Главная</a></li>
          <li><a href="https://github.com/lissy93/personal-security-checklist">
            <Icon class="mr-2" icon="github" width={16} height={16}  />GitHub</a>
          </li>
          <li>
            <a href="/checklist"><Icon class="mr-2" icon="all" width={16} height={16} />Контрольные списки</a>
            <ul>
              {data.value.map((item: Section, index: number) => (
          ...
          <li>
            <a href="/article">
              <Icon class="mr-2" icon="articles" width={16} height={16} />Статьи
            </a>
            <ul>
          ...
          <li>
            <a href="/about">
              <Icon class="mr-2" icon="about" width={16} height={16} />О проекте
            </a>
            <ul>
              <li>
      ...
      <dialog id="settings_modal" class="modal">
        <div class="modal-box">
          <div class="tabs tabs-lifted">
            <p class="tab tab-active">Настройки</p>
            <a class="tab" href="/about">О проекте</a>
          </div>
          <div class="modal-action justify-start w-full flex flex-col gap-4">
              ...
              <div class="flex items-between w-full justify-between">
                <label class="label">Данные</label>
                <button class="btn btn-primary" onClick$={deleteAllData}>Удалить всё</button>
              </div>
              <button
